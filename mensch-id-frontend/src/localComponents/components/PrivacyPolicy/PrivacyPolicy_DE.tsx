export const PrivacyPolicyDe = () => {
    ...
    return (
        <>
            <p>
                Diese Datenschutzerklärung beschreibt wie mensch.ID die persönlichen Daten verwendet die gesammelt werden wenn du die Webseite benutzt.
            </p>
            <h3>Themen:</h3>
            <ul>
            ...
            <p>mensch.ID speichert die folgenden Daten:</p>
            <ul>
                <li>Geburtsdatum (um deine mensch.ID zu generieren)</li>
                <li>Email-Adresse (nur wenn du ein nicht-anonymes lokales Konto verwendest. Notwendig um Passwortrücksetzung anzubieten)</li>
                <li>Externe Konto-ID (wenn du dein Google-, Facebook-, Twitter- ode Microsoft-Konto zur Anmeldung nutzt)</li>
            </ul>
            <p>mensch.ID hat außerdem Zugang zu folgenden Daten, die aber weder genutzt noch gespeichert werden:</p>
            <ul>
                <li>Wenn du einen externen Anmeldedienst nutzt (Google, Facebook, Twitter, Microsoft): Jegliche Information die der Anmeldedienst mitschickt. Enthält typischerweise, aber nicht ausschließlich: Deinen Namen, weitere Konto-IDs, Links zu deinem Profil.</li>
                <li>Deine öffentliche IP-Adresse</li>
            </ul>
            <h3>Wie werden die Daten gesammelt?</h3>
            <p>
                Du teilst mensch.ID die meisten dieser Daten direkt mit. Dies passiert wenn du:
            </p>
            <ul>
                <li>Dich registriert oder anmeldest</li>
                <li>Weite Konten verlinkst</li>
            </ul>
            <p>
                mensch.ID empfängt auch indirekt Daten von diesen Quellen:
            </p>
            <ul>
                <li>Externe Anmeldedienste (Google, Facebook, Twitter, Microsoft; wenn du dich anmeldest)</li>
            </ul>
            <h3>Wie werden die Daten verwendet?</h3>
            <p>mensch.ID sammelt die Daten damit du:</p>
            <ul>
                <li>Dich anmelden kannst</li>
                <li>Eine mensch.ID erstellen</li>
            </ul>
            ...
            <p>
                Möchtest du dich beschweren oder findest du dass mensch.ID dein Anliegen nicht zufriedenstellend adressiert hat, kannst du den European Data Protection Supervisor. kontaktieren
            </p>
            <p>
