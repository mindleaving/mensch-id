...
interface ChallengeReceiverCardProps {
    challengeData: Models.MenschIdChallenge;
}

export const ChallengeReceiverCard = (props: ChallengeReceiverCardProps) => {
            ...
            <Card.Body>
                ...
                <Row className='my-3'>
                    <Col>
                        ...
                        <div>
                            <small>{resolveText("ReceiveChallenge_Secret_Description")}</small>
                        </div>
                    </Col>
